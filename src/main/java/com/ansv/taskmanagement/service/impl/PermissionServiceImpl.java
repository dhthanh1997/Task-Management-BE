...
public class PermissionServiceImpl implements PermissionService {
    ...
    private static final BaseMapper<Permission, PermissionDTO> mapper = new BaseMapper<>(Permission.class, PermissionDTO.class);
...
//        try {
        ...
        PermissionDTO dto = findById(item.getId());
...
//        }
    ...
    public List<PermissionDTO> findAll() {
        List<Permission> entities = repository.findAll();
        return mapper.toDtoBean(entities);
    }

    @Override
    public List<PermissionDTO> search(Map<String, Object> mapParam) {
        return null;
    }

    @Override
    public Page<PermissionDTO> findBySearchCriteria(Optional<String> search, Pageable page) {
//        try {
        GenericSpecificationBuilder<Permission> builder = new GenericSpecificationBuilder<>();
